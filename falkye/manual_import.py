...
from falkye.matching import spheres_probables
from falkye.models.notification import ModeUsage, Notification
...
def persist_raw_signal(
    ...
    *,
    ...
    d'un connecteur automatisé (falkye/engine.py), d'un import manuel d'un
...
def importer_document_manuel(
    ...
    *,
    ...
    signal automatisé : même résolution NEQ (falkye.resolution.
    ...
    (ex. nature_bien pour RDPRM, voir falkye/scoring.py)."""
...
def traiter_apres_import(
    ...
    from falkye.engine import _traiter_entreprise_pour_profil, deliver_notification

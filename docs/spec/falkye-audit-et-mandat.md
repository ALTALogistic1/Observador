...
**62 entrées, 17 tranchées.** *Relu le 23 septembre 2026 en ajoutant D62 et D63 : 60 → 62 entrées, et D61 et D62 passent tranchées.* ⚠️ **Deux entrées ne comptent PAS comme tranchées, et il faut le dire** : **D63** est ⏸️ *en suspens* — la question se REPOSERA à la réouverture, elle n'est pas close; **D60** garde son ⬜ — *son UNITÉ est tranchée (la lettre), sa VALEUR ne l'est pas*, et une entrée à moitié tranchée se compte comme ouverte. *Compte relu dans le tableau le 22 septembre 2026 — il annonçait

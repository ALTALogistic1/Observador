...
| D4 | Prix du palier supérieur | Spéc. 12.1, charte §5, `strategie-et-personas.md` | ⬜ *à dater — et le « à dater » n'a lui-même jamais été daté.* **Constaté le 11 septembre 2026 :** *(a)* le renvoi de cette entrée pointait vers **spéc. §15**, qui ne porte plus la table — elle est en **12.1** *(corrigé)*; *(b)* **la table des paliers est recopiée dans trois documents**, et **une seule des trois copies portait ce renvoi**, les deux autres se lisant comme un prix arrêté *(renvoi ajouté aux trois)*; *(c)* **aucune des trois ne porte de date**, ni de fixation ni de dernière révision. **Ce qui manque pour clore :** depuis quand le « à réviser » est posé, et **la condition qui le lève** — une mention de révision sans déclencheur est une décision non tranchée, et une décision non tranchée disparaît *(charte §15, faille I, journal cas 15)*. *Où vit la table : D35.* |
...
| D35 | Où vit la table des paliers, et laquelle des trois copies fait foi | Charte §5, spéc. 12.1, `strategie-et-personas.md` | ⬜ **avec D4.** La même table de prix existe **dans trois documents**, ce que le guide interdit ailleurs en toutes lettres — *une phrase qui a une source de vérité ailleurs n'a rien à faire là*. **Et les copies divergent déjà :** la spécification et la stratégie écrivent *« 29,99 $/mois, **jamais gratuit** »*; **la charte omettait « jamais gratuit »** — le document qui tranche en cas de contradiction était le moins complet des trois, sur l'affirmation exacte que le README avait contredite *(corrigé le 11 septembre 2026)*. **Ce qui reste à trancher : laquelle fait foi, et ce que les deux autres deviennent** — un renvoi, ou rien. *La règle du corpus penche vers la spécification, qui porte l'état à jour; la charte porte la structure de plans comme principe. Les deux lectures se défendent, et aucune ne se tranche en passant.* |

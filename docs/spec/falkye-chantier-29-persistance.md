...
composite `ix_companies_neq_nom_normalise` a réduit cette fuite-là sans la fermer : le repli par
sous-chaîne balaie toujours 8 396 lignes **sur la base durable, donc facturées**.

...
Québec). 13 sources actives à ce jour (état au 2026-09-01, voir `observador
...
d'accès — voir `docs/STATUT_RESEAU.md`]) plus cinq sources de Phase 2 :
...
et **contrats publics attribués — Nouvelle-Écosse**, première source hors
Québec pour les appels d'offres (voir `docs/STATUT_RESEAU.md`). **Growth 500**
...
(confirmé). Équivalents provinciaux à SEAO/REQ évalués (7 candidats
appels d'offres, 5 candidats registres d'entreprises) : la Nouvelle-Écosse
est le seul équivalent SEAO automatisable trouvé ; **aucune province n'offre
d'équivalent REQ automatisable et gratuit** — Corporations Canada reste le
seul registre pancanadien en vrac (limite connue : fédéral seulement) — voir
`docs/STATUT_RESEAU.md` pour le détail de chaque investigation.
**Licences d'affaires municipales — Vancouver/Toronto** en cours de
construction (mécanisme de vérification croisée avec Corporations Canada
déjà en place, connecteurs à venir). **Permis de construction — Montréal et
Québec** restent `à

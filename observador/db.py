...
voir OBSERVADOR_DB_URL dans .env.example. Le choix technique de la base de données
...
DEFAULT_DB_URL = "sqlite:///./data/observador.sqlite3"


def get_db_url() -> str:
    return os.environ.get("OBSERVADOR_DB_URL", DEFAULT_DB_URL)
...
def init_db() -> None:
    ...
    ou production."""
    import observador.models  # noqa: F401 -- garantit que tous les modèles sont importés
...
def seed_spheres_from_registry() -> None:
    ...
    from observador.models.sphere import Sphere

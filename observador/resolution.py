...
from observador.models.company import Company, StatutLegal, StatutResolution
from observador.sources import req as req_source
...
def _find_unresolved_company(db_session: Session, nom_detecte: str) -> Company | None:
    ...
    observador/models/company.py (sinon quadratique sur de gros volumes, ex. SEAO)."""

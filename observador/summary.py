...
from observador.models.notification import Notification, PeriodicSummary
from observador.models.profile import Profile
from observador.notifications.base import NotificationContent
...
def formatter_resume(
    ...
    sujet = f"[Repéreur] Résumé du {debut} au {fin}"

...
1. **Pas un simple renouvellement.** Découverte réelle : un NOUVEAU numéro de
   ...
   (`LicenceMunicipaleEntry`, voir observador/sources/
...
from observador.resolution import SEUIL_AMBIGUITE_ECART_MIN, SEUIL_RESOLUTION_CONFIANTE
...
from observador.sources.corporations_canada import resolve_corp_federale_by_name
from observador.sources.licences_municipales_communes import LicenceBrute, detecter_nouvelles_licences

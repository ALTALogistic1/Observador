...
CACHE_DIR = Path(os.environ.get("OBSERVADOR_CACHE_DIR", "./cache"))

DEFAULT_USER_AGENT = os.environ.get(
    "OBSERVADOR_USER_AGENT",
    "Observador/0.1 (repereur d'entreprises en croissance; usage a but non lucratif)",
)
